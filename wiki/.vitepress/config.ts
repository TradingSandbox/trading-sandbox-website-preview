...
const ORGANIZATION_JSON_LD = {
  ...
  description: 'tradecli publishes the local-first, agent-native trading OS for Indian markets.',
...
const WEBSITE_JSON_LD = {
  ...
  url: 'https://tradecli.in/',
  description: 'tradecli.in is the official website for tradecli and the documentation hub for the agent-native trading OS for Indian markets.',
  inLanguage: 'en-IN',
